...
def load_processed_dataset():
    ...
    df = utils.open_dataset("src/datasets/heartdisease/heart_disease.csv")
    return df
...
def run_model_training():
    ...
    for i in range(30):
        ...
        for keys, item in results.items():
            utils.to_csv("src/output/reports/heartdisease/heartdisease_reports.csv", item, "heart_disease")
...
def training_model(dataset, index, process_results):
    ...
    pickle.dump(lr_model_pipeline, open(f'src/output/standard_models/heartdisease/lr_model_{index}.sav', 'wb'))
    pickle.dump(rf_model_pipeline, open(f'src/output/standard_models/heartdisease/rf_model_{index}.sav', 'wb'))
    pickle.dump(xgb_model_pipeline, open(f'src/output/standard_models/heartdisease/xgb_model_{index}.sav', 'wb'))
    pickle.dump(svm_model_pipeline, open(f'src/output/standard_models/heartdisease/svm_model_{index}.sav', 'wb'))
    ...
    lr_results = {
        ...
        'size': utils.get_mb_size(f"src/output/standard_models/heartdisease/lr_model_{index}.sav")
    }
    rf_results = {
        'dataset': 'heart_disease',
        'iteration': index + 1,
        ...
        'size': utils.get_mb_size(f"src/output/standard_models/heartdisease/rf_model_{index}.sav")
    }
    svm_results = {
        'dataset': 'heart_disease',
        'iteration': index + 1,
        ...
        'size': utils.get_mb_size(f"src/output/standard_models/heartdisease/svm_model_{index}.sav")
    }
    xgb_results = {
        'dataset': 'heart_disease',
        'iteration': index + 1,
        ...
        'size': utils.get_mb_size(f"src/output/standard_models/heartdisease/xgb_model_{index}.sav")
    }
